  ...
  return (
    <div className="flex items-center justify-between p-4 md:hidden">
      <a href="https://gumroad.com/">
        <svg xmlns="http://www.w3.org/2000/svg" width="23" height="23" fill="none" viewBox="0 0 81 81">
          ...
          <path fill="#FF90E8" stroke="#000" strokeWidth="1.557" d="M38.605 76.433c20.892 0 37.828-16.936 37.828-37.828 0-20.89-16.936-37.827-37.828-37.827C17.715.778.779 17.714.779 38.606c0 20.89 16.936 37.827 37.828 37.827Z"/>
      ...
      <h1 className="text-base text-center flex-1">Dashboard</h1>
      <button aria-label="Toggle navigation">
        <svg width="24" height="24" fill="none" xmlns="http://www.w3.org/2000/svg">
          <path d="M4 6.008h16m-16 6h16m-16 6h16" stroke="#fff" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
        </svg>
      </button>
    </div>
  );
